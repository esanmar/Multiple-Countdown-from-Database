...
define("EW_PROJECT_NAME", "cronoTC", TRUE); // Project name
define("EW_RANDOM_KEY", 'uxTPr7S1puoXa87h', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "cronoTC.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'cronotc', TRUE);
